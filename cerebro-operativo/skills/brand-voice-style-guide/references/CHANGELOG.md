...
|---------|------|---------|--------------|
| 1.2.0 | 2026-09-22 | *(this commit)* | Inside a brain, writes the guide to the path the vocabulary block names for the voice file, with every heading in the brain's working language; separates the language the guide is written in from the languages whose voice it describes. Outside a brain, writes voice.md where the person says. |
