...
|---|---|---|
| <Nombre> | <Cargo> | responsable del cerebro |
| <Nombre> | <Cargo> | <editor o consulta> |
...
<idioma de los clientes si es distinto; si no, español>. Lo fijó <Organización> al instalar y
no cambia.
...
| `documentos/` | Los documentos que <Organización> ya tenía (manuales, procedimientos, plantillas). Los originales no se tocan. |
